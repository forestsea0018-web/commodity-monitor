...
INFRA_ROWS = [
    ...
    ("固态变压器", "数字化固态变压器，AIDC配电核心",
     "四方股份",  "601126.SH", "上交所",      "固态变压器/继电保护", "CNY", "—"),
    ("固态变压器", "高压开关设备/固态变压器",
     "中国西电",  "601179.SH", "上交所",      "高压开关/固态变压器", "CNY", "—"),
    ("固态变压器", "电源变压器/固态变压器",
     "伊戈尔",    "002922.SZ", "深交所",      "变压器/电源模块",     "CNY", "—"),
    ("固态变压器", "干式变压器/固态变压器",
     "金盘科技",  "688676.SH", "上交所科创板","干式变压器/固态变压器","CNY","—"),
]
...
def build(filename="半导体全产业链标的.xlsx"):
    ...
    wb.save(filename)
    print(f"[OK] {filename}  主表 {len(ROWS)} 行  基础设施副表 {len(INFRA_ROWS)} 行")
